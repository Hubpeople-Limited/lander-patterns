...
A **pricing** page shell. The pricing page as a table of criteria rather than a row of tier cards - the shape for a brand whose tiers differ on many small things rather than on one headline number.
