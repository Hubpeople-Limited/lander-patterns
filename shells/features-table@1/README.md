...
2. **hero-stated** v4 (ground=deep) - **the opening region's default**, in `opening-default.html`, not in `page.html` - An opener made of words - a display claim, one supporting line and the join control - on a choice of three grounds and two alignments, with no photograph anywhere in it.
