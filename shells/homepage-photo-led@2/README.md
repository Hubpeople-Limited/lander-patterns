...
- **The opening** - `hero-overlay` is the shipped default, and the menu recipes describe that default; neither has decided this page's opening. Decide it from the material: another opener from INDEX.md, the content's own first row, a real member's words, or nothing above the content at all - and keep the default only where you can say why it beats those here.
