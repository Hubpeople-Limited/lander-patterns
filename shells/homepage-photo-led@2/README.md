...
- **The opening** - `hero-overlay` is the shipped default. A page may open instead on another opener from INDEX.md, on the content's own first row, or on nothing above the content at all. The recipe's `opens:` line, or the material, decides.
