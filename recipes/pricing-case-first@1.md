...
figure appears, the reason for it has already been read, and the marks
underneath answer the doubt that arrives immediately after.

It does not serve somebody in a hurry. A visitor who came only to check the
price has to scroll past an argument to find it, which is exactly the right
trade for a considered brand and exactly the wrong one for a cheap, obvious
offer.
