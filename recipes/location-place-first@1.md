...
guesses wrong in a way that reads perfectly well and is not true.

The members block is filled by the platform, so the page carries first-party data
no competitor holds and a crawler receives it in the HTML. The note under it is
where the honest caveat goes about what the block is showing. The sibling places
