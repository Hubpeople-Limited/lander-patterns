```recipe
recipe: homepage-said-plainly@1
shape: single-claim
...
photography is honest; a page with borrowed photography is not, and visitors
recognise the difference faster than anyone expects.

It does not carry a mood. Without images the feeling of the page comes entirely
from the typeface and the brand colour, so a brand with weak or unresolved
tokens gets a plain page rather than a striking one. Come back to a photographic
front page once there is real material to put on it.
